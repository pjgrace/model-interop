...
import uk.ac.soton.itinnovation.xifiinteroperability.*;
 ...
 * @author pjg
 */
public class XMLInputException extends Exception {
     ...
     */
    public XMLInputException(final String errorMsg, final Exception excep) {
     ...
     */
    public XMLInputException(final String errorMsg) {
        super(errorMsg);
    }
}
