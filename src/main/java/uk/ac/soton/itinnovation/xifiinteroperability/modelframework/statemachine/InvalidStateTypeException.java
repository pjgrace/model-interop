...
public class InvalidStateTypeException extends Exception {
    ...
    /**
     * Create a state machine type exception (not a valid state).
     * @param exceptionMsg The added error message.
     */
    public InvalidStateTypeException(final String exceptionMsg) {
        super(exceptionMsg);
    }
}
