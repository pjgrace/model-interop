...
public class Reference implements Serializable, Cloneable {
     ...
     *         supported.
     */
    public static String decode(final String toDecode, final CharacterSet characterSet) {
     ...
     * @return The encoded string.
     */
    public static String encode(final String toEncode, final boolean queryString) {
     ...
     *         supported.
     */
    public static String encode(final String toEncode, final CharacterSet characterSet) {
     ...
     */
    private static boolean isAlpha(final int character) {
     ...
     *         character.
     */
    public static boolean isGenericDelimiter(final int character) {
     ...
     */
    private static boolean isLowerCase(final int character) {
     ...
     */
    public static boolean isReserved(final int character) {
     ...
     *         character.
     */
    public static boolean isSubDelimiter(final int character) {
        return (character == '!') || (character == '$') || (character == '&')
                || (character == '\'') || (character == '(')
                || (character == ')') || (character == '*')
                || (character == '+') || (character == ',')
     ...
     */
    public static boolean isUnreserved(final int character) {
     ...
     */
    private static boolean isUpperCase(final int character) {
        return (character >= 'A') && (character <= 'Z');
    }
     ...
     */
    public static boolean isValid(final int character) {
     ...
     */
    public static String toString(final String scheme, final String hostName,
            final Integer hostPort, final String path, final String query, final String fragment) {
     ...
     */
    public static String toString(final String relativePart, final String query,
            final String fragment) {
        final StringBuilder strBuild = new StringBuilder();

        // Append the path
        if (relativePart != null) {
            strBuild.append(relativePart);
        }

        // Append the query string
        if (query != null) {
            strBuild.append('?').append(query);
        }

        // Append the fragment identifier
        if (fragment != null) {
            strBuild.append('#').append(fragment);
        }
     ...
     */
    public static String toString(final String scheme, final String host, final String path,
           final  String query, final String fragment) {
        final StringBuilder strBuild = new StringBuilder();

        if (scheme != null) {
            // Append the scheme and host name
            strBuild.append(scheme.toLowerCase(Locale.ENGLISH)).append("://").append(host);
        }
     ...
     */
    public Reference(final java.net.URI uri) {
        this(uri.toString());
    }
     ...
     *            The {@link java.net.URI} instance.
     */
    public Reference(final java.net.URI baseUri, final java.net.URI uri) {
     ...
     */
    public Reference(final java.net.URL url) {
        this(url.toString());
    }
     ...
     *            The host name or IP address.
     */
    public Reference(final Protocol protocol, final String hostName) {
     ...
     *            The host port (default ports are correctly ignored).
     */
    public Reference(final Protocol protocol, final String hostName, final int hostPort) {
     ...
     */
    public Reference(final Reference newBaseRef, final Reference uriReference) {
        this(newBaseRef, uriReference.toString());
    }
     ...
     *            The URI reference, either absolute or relative.
     */
    public Reference(final Reference newBaseRef, final String uriRef) {
        this.baseRef = newBaseRef;
        this.internalRef = encodeInvalidCharacters(uriRef);
        updateIndexes();
    }
     ...
     *            The optional fragment identifier.
     */
    public Reference(final Reference newBaseRef, final String relativePart, final String query,
            final String fragment) {
        this(newBaseRef, toString(relativePart, query, fragment));
    }
     ...
     *            The URI reference, either absolute or relative.
     */
    public Reference(final String uriReference) {
     ...
     */
    public Reference(final String identifier, final String fragment) {
     ...
     *            The optional fragment identifier.
     */
    public Reference(final String scheme, final String hostName, final int hostPort, final String path,
            final String query, final String fragment) {
     ...
     */
    public final Reference addQueryParameter(final Parameter parameter) {
     ...
     * @return The updated reference.
     */
    public final Reference addQueryParameter(final String name, final String value) {
     ...
     * @return The updated reference.
     */
    public final Reference addQueryParameters(final Iterable<Parameter> parameters) {
     ...
     * @return The updated reference.
     */
    public final Reference addSegment(final String value) {
    ...
    // [ifndef gwt] method
    @Override
    public final Reference clone() throws CloneNotSupportedException {
     ...
     *         encoded.
     * @throws IllegalArgumentException Error in the input parameter.
     */
    private String encodeInvalidCharacters(final String uriRef)
                ...
                for (int i = 0; (i < uriRef.length()); i++) {
                    if (isValid(uriRef.charAt(i))) {
                        if ((uriRef.charAt(i) == '%')
                            ...
                            strBuild.append(uriRef.charAt(i));
                        }
                    } else {
                        strBuild.append(encode(String.valueOf(uriRef.charAt(i))));
                    }
                }
     ...
     * @see #getAuthority()
     */
    public final String getAuthority(final boolean decode) {
     ...
     */
    public final Reference getBaseRef() {
        return this.baseRef;
    }
     ...
     * @see #getExtensions()
     */
    public final String[] getExtensionsAsArray() {
        String[] result = null;
     ...
     * @see #getFragment()
     */
    public final String getFragment(final boolean decode) {
     ...
     */
    public final String getHierarchicalPart() {
        if (hasScheme()) {
            // Scheme found
            if (hasQuery()) {
                // Query found
     ...
     */
    public final String getHierarchicalPart(final boolean decode) {
    ...
    public final String getHostDomain() {
        ...
        if (authority != null) {
            ...
            final int indexUI = authority.indexOf('@'); // user info
            final int indexIPV6 = authority.indexOf(']'); // IPV6
            final int indexP = authority.indexOf(':', (indexIPV6 == -1) ? indexUI
                    : indexIPV6);
     ...
     * @see #getHostDomain()
     */
    public final String getHostDomain(final boolean decode) {
     ...
     */
    public final String getHostIdentifier(final boolean decode) {
    ...
    public final int getHostPort() {
        ...
        if (authority != null) {
            ...
            final int indexUI = authority.indexOf('@'); // user info
            final int indexIPV6 = authority.indexOf(']'); // IPV6
            final int index = authority.indexOf(':', (indexIPV6 == -1) ? indexUI
                    : indexIPV6);
     ...
     * @see #getIdentifier()
     */
    public final String getIdentifier(final boolean decode) {
     ...
     * @see #getLastSegment()
     */
    public final String getLastSegment(final boolean decode) {
     ...
     *            Indicates if the result should be decoded using the
     *            {@link #decode(String)} method.
     * @param excludeMatrix The martrix to exclude
     * @return The optionnally decoded last segment.
     * @see #getLastSegment()
     */
    public final String getLastSegment(final boolean decode, final boolean excludeMatrix) {
     ...
     * @see #getMatrix()
     */
    public final String getMatrix(final boolean decode) {
     ...
     */
    public final Form getMatrixAsForm() {
     ...
     */
    public final Form getMatrixAsForm(final org.restlet.data.CharacterSet characterSet) {
     ...
     */
    public final Reference getParentRef() {
     ...
     * @see #getPath()
     */
    public final String getPath(final boolean decode) {
     ...
     * @see #getQuery()
     */
    public final String getQuery(final boolean decode) {
     ...
     */
    public final Form getQueryAsForm() {
     ...
     * @return The optional query component as a form.
     */
    public final Form getQueryAsForm(final boolean decode) {
     ...
     */
    public final Form getQueryAsForm(final org.restlet.data.CharacterSet characterSet) {
     ...
     * @see #getRelativePart()
     */
    public final String getRelativePart(final boolean decode) {
     ...
     */
    public final Reference getRelativeRef() {
    ...
    public final Reference getRelativeRef(final Reference base) {
        ...
        if (base == null) {
            ...
            if ((basePath == null) || (localPath == null)) {
                ...
                int index = 0;
                char current;
                while (!diffFound && (index < localPath.length())
                        && (index < basePath.length())) {
                    current = localPath.charAt(index);
                    if (current != basePath.charAt(index)) {
                        diffFound = true;
                    } else {
                        if (current == '/') {
                ...
                if (!diffFound) {
                    if (localPath.length() == basePath.length()) {
                        ...
                        if (basePath.charAt(index) == '/') {
                            if ((index + 1) == basePath.length()) {
                                // Both paths are strictly equivalent
                                relativePath = ".";
                            } else {
                                // The local path is a direct parent of the base
                                // path We need to add enough ".." in the relative path
                                final StringBuilder strBuild = new StringBuilder();

                                int segments = 0;
                                for (int j = basePath.indexOf('/', index); j != -1; j = basePath
                                        .indexOf('/', j + 1)) {
                                    segments++;
                                }
                                // Build relative path
                                ...
                                final int lastLocalSlash = localPath.lastIndexOf('/');
                                strBuild.append(localPath
                                        .substring(lastLocalSlash + 1));

                                relativePath = strBuild.toString();
                            }
                        } else {
                        ...
                        if (localPath.charAt(index) == '/') {
                            if ((index + 1) == localPath.length()) {
                                ...
                                relativePath = localPath.substring(index + 1);
                            }
                        } else {
                    ...
                    strBuild.append(localPath.substring(lastSlashIndex + 1));
     ...
     */
    public final String getRemainingPart() {
     ...
     */
    public final String getRemainingPart(final boolean decode) {
     ...
     * @see #getRemainingPart()
     */
    public final String getRemainingPart(final boolean decode, final boolean query) {
        String result = null;
     ...
     * @see #getScheme()
     */
    public final String getScheme(final boolean decode) {
     ...
     */
    public final Protocol getSchemeProtocol() {
     ...
     */
    public final String getSchemeSpecificPart(final boolean decode) {
     ...
     * @see #getSegments()
     */
    public final List<String> getSegments(final boolean decode) {
     ...
     */
    public final Reference getTargetRef() {
        Reference result = null;
     ...
     * @see #getUserInfo()
     */
    public final String getUserInfo(final boolean decode) {
     ...
     * @see #getMatrix()
     */
    public final boolean hasMatrix() {
     ...
     */
    public final boolean isEquivalentTo(final Reference ref) {
     ...
     *         reference.
     */
    public final boolean isParent(final Reference childRef) {
        boolean result = false;
     ...
     */
    public final Reference normalize() {
     ...
     */
    private void removeLastSegment(final StringBuilder output) {
        int min = -1;
     ...
     *            The base reference for relative references.
     */
    public final void setBaseRef(final Reference newBaseRef) {
        this.baseRef = newBaseRef;
    }
     ...
     */
    public final void setBaseRef(final String baseUri) {
     ...
     * @see #setExtensions(String[])
     */
    public final void setExtensions(final String extensions) {
        final String lastSegment = getLastSegment();
        ...
        if (lastSegment != null) {
            ...
            if (extensionIndex != -1) {
                // Extensions found
                strBuild.append(lastSegment.substring(0, extensionIndex));

                if ((extensions != null) && (extensions.length() > 0)) {
                    strBuild.append('.').append(extensions);
                }

                if (matrixIndex != -1) {
                    strBuild.append(lastSegment.substring(matrixIndex));
                }
            } else {
                ...
                if ((extensions != null) && (extensions.length() > 0)) {
                    if (matrixIndex != -1) {
                        ...
                        strBuild.append(lastSegment.substring(0, matrixIndex))
                                .append('.').append(extensions)
                                .append(lastSegment.substring(matrixIndex));
                    } else {
                        // No matrix found, just append the extensions
                        strBuild.append(lastSegment).append('.').append(extensions);
                    }
                } else {
                    // No change necessary
                    strBuild.append(lastSegment);
                }
            }

            // Finally update the last segment
            setLastSegment(strBuild.toString());
        } else {
    ...
    public final void setExtensions(final String[] extensions) {
        ...
        if (extensions != null) {
            ...
            for (int i = 0; i < extensions.length; i++) {
                ...
                strBuild.append(extensions[i]);
            }

            exts = strBuild.toString();
        }
     ...
     */
    public final void setHostDomain(final String newDomain) {
        final String authority = getAuthority();
     ...
     *            identifiers.
     */
    public final void setHostPort(final Integer port) {
        final String authority = getAuthority();
     ...
     *
     * @param newIdentifier The absolute resource identifier.
     */
    public final void setIdentifier(final String newIdentifier) {
        String identifier = encodeInvalidCharacters(newIdentifier);
     ...
     */
    public final void setLastSegment(final String lastSegment) {
        final String path = getPath();
     ...
     *
     * @param newScheme The scheme component.
     */
    public final void setScheme(final String newScheme) {
        String scheme = encodeInvalidCharacters(newScheme);
     ...
     *
     * @param nSchemeSpecPart
     *            The scheme specific part.
     */
    public final void setSchemeSpecificPart(final String nSchemeSpecPart) {
        String schemeSpecPart = encodeInvalidCharacters(nSchemeSpecPart);

        if (schemeSpecPart == null) {
            schemeSpecPart = "";
        }
        ...
        if (hasScheme()) {
            ...
            if (hasFragment()) {
                ...
                // No fragment found
                this.internalRef = this.internalRef.substring(0,
                        this.schemeIndex + 1) + schemeSpecPart;
            }
        } else {
            // No scheme found
            if (hasFragment()) {
                // Fragment found
                this.internalRef = schemeSpecPart
                        + this.internalRef.substring(this.fragmentIndex);
            } else {
                // No fragment found
                this.internalRef = schemeSpecPart;
     ...
     */
    public final void setSegments(final List<String> segments) {
        final StringBuilder strBuild = new StringBuilder();

        for (final String segment : segments) {
            strBuild.append('/').append(segment);
        }

        setPath(strBuild.toString());
    }
     ...
     */
    public final String toString(final boolean query, final boolean fragment) {
        if (query) {
            if (fragment) {
                return this.internalRef;
            }
