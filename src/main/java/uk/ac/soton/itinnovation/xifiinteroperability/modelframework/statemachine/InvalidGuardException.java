...
public class InvalidGuardException extends Exception {
     ...
     */
    public InvalidGuardException(final String exceptionMessage) {
        super(exceptionMessage);
    }

    /**
     * Construct a guard exception with a given error message, and a
     * previously caught exception.
     * @param exceptionMessage The error message.
     * @param excep The prior caught exception.
     */
    public InvalidGuardException(final String exceptionMessage, final Exception excep) {
