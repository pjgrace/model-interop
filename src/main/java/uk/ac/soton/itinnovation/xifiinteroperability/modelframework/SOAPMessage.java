 ...
 * @author Paul Grace
 */
public class SOAPMessage extends ProtocolMessage{
     ...
     */
    public SOAPMessage(final String urlstr, final String pathstr, final String methodStr, final String type, final String body,
