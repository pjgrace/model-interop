...
public class InvalidJSONPathException extends Exception {
     ...
     */
    public InvalidJSONPathException(final String exceptionMessage) {
        super(exceptionMessage);
    }

    /**
     * Construct an invalid JSONPath exception with a given error message, and a
     * previously caught exception.
     * @param exceptionMessage The error message passed to this exception.
     * @param excep The prior caught exception.
     */
    public InvalidJSONPathException(final String exceptionMessage, final Exception excep) {
